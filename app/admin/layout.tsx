    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <aside className="w-60 shrink-0 flex flex-col bg-[#0F0A2A] text-white">
        ...
        <div className="flex items-center gap-3 px-5 py-5 border-b border-white/10">
          <div className="h-8 w-8 rounded-lg bg-[#7C3AED] flex items-center justify-center font-bold text-sm">
            P
          </div>
          <div>
        ...
        <nav className="flex-1 px-3 py-4 space-y-0.5">
          <p className="text-[10px] uppercase font-semibold tracking-widest text-purple-400 px-3 mb-2">
            Gestión
          </p>
          {navItems.map((item) => {
        ...
        <div className="p-4 border-t border-white/10 space-y-2">
          <Link
            href="/"
            className="flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-purple-300 hover:bg-white/10 hover:text-white transition-all"
          >
          ...
          <div className="flex items-center gap-2 px-3 pt-2">
            <div className="h-7 w-7 rounded-full bg-[#7C3AED] flex items-center justify-center text-xs font-bold shrink-0">
              {initials}
            </div>
